module.exports = {
  ...
  async down(queryInterface, Sequelize) {
    ...
    try {
      ...
      await queryInterface.removeColumn('smart_contracts', 'organizationId', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('audits', 'organizationId', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('smart_contracts', 'teamId', {
        transaction,
      });

      await queryInterface.removeColumn('smart_contracts', 'developerId', {
        transaction,
      });

      await queryInterface.removeColumn('smart_contracts', 'deployed_at', {
        transaction,
      });

      await queryInterface.removeColumn('smart_contracts', 'status', {
        transaction,
      });

      await queryInterface.removeColumn('smart_contracts', 'code', {
        transaction,
      });

      await queryInterface.removeColumn('smart_contracts', 'name', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('audits', 'audited_at', {
        transaction,
      });

      await queryInterface.removeColumn('audits', 'result', { transaction });

      await queryInterface.removeColumn('audits', 'report', { transaction });

      await queryInterface.removeColumn('audits', 'auditorId', { transaction });

      await queryInterface.removeColumn('audits', 'smart_contractId', {
        transaction,
      });
