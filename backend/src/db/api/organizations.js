...
module.exports = class OrganizationsDBApi {
  ...
  static async findBy(where, options) {
    ...
    output.audits_organization = await organizations.getAudits_organization({
      transaction,
    });

    output.notifications_organization =
      await organizations.getNotifications_organization({
        transaction,
      });

    output.smart_contracts_organization =
      await organizations.getSmart_contracts_organization({
        transaction,
      });
