    ...
    <>
      ...
      <SectionMain>
        ...
        <CardBox>
            ...
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {users.audits_auditor &&
                      Array.isArray(users.audits_auditor) &&
          ...
          <>
            <p className={'block font-bold mb-2'}>Smart_contracts Developer</p>
            <CardBox
              className='mb-6 border border-gray-300 rounded overflow-hidden'
              hasTable
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {users.smart_contracts_developer &&
                      Array.isArray(users.smart_contracts_developer) &&
                      users.smart_contracts_developer.map((item: any) => (
                        <tr
                          key={item.id}
                          onClick={() =>
                            router.push(
              ...
              {!users?.smart_contracts_developer?.length && (
                <div className={'text-center py-4'}>No data</div>
              )}
            </CardBox>
          </>
