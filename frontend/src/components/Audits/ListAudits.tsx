...
const ListAudits = ({
  ...
  const hasUpdatePermission = hasPermission(currentUser, 'UPDATE_AUDITS');
              ...
              <div className={'flex items-center overflow-hidden'}>
                ...
                >
                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs text-gray-500'}>SmartContract</p>
                    <p className={'line-clamp-2'}>
                      {dataFormatter.smart_contractsOneListFormatter(
                        item.smart_contract,
                      )}
                    </p>
                  </div>
                  ...
                  <div className={'flex-1 px-3'}>
                    ...
                    <p className={'line-clamp-2'}>{item.report}</p>
                  </div>
                  ...
                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs text-gray-500'}>AuditedAt</p>
                    <p className={'line-clamp-2'}>
